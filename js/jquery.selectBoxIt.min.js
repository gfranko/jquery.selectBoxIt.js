...
$(function(){$.selectBox.selectBoxIt.prototype.disable=function(e,t){var n=this;return n.options.disabled||(n.close(),n.selectBox.trigger("disable").attr("disabled","disabled"),n.div.removeAttr("tabindex").addClass("selectboxit-disabled"),$.Widget.prototype.disable.call(n)),n._callbackSupport(t),n},$.selectBox.selectBoxIt.prototype.disableOption=function(e,t){var n=this,r,i=0,s,o;return typeof e=="number"&&(n.close(),r=n.selectBox.find("option").eq(e),i=n.options.showFirstOption?e:e-1>=0?e:0,n.selectBox.trigger("disable-option"),r.attr("disabled","disabled"),n.listItems.eq(e).attr("data-disabled","true").addClass("ui-state-disabled"),n.currentFocus===e&&(s=n.listItems.eq(n.currentFocus).nextAll("li").not("[data-disabled='true']").first().length,o=n.listItems.eq(n.currentFocus).prevAll("li").not("[data-disabled='true']").first().length,s?n.moveDown():o?n.moveUp():n.disable())),n._callbackSupport(t),n},$.selectBox.selectBoxIt.prototype._isDisabled=function(e){var t=this;return t.originalElem.disabled&&t.disable(),t}});
...
$(function(){$.selectBox.selectBoxIt.prototype.moveDown=function(e){var t=this;t.currentFocus+=1;var n=t.listItems.eq(t.currentFocus).attr("data-disabled")==="true"?!0:!1,r=t.listItems.eq(t.currentFocus).nextAll("li").not("[data-disabled='true']").first().length;if(t.currentFocus===t.listItems.length)t.currentFocus-=1;else{if(n&&r){t.listItems.eq(t.currentFocus-1).blur(),t.moveDown();return}n&&!r?t.currentFocus-=1:(t.listItems.eq(t.currentFocus-1).blur().end().eq(t.currentFocus).focus(),t._scrollToView("down"),t.selectBox.trigger("moveDown"))}return t._callbackSupport(e),t},$.selectBox.selectBoxIt.prototype.moveUp=function(e){var t=this;t.currentFocus-=1;var n=t.listItems.eq(t.currentFocus).attr("data-disabled")==="true"?!0:!1,r=t.listItems.eq(t.currentFocus).prevAll("li").not("[data-disabled='true']").first().length;if(t.currentFocus===-1)t.currentFocus+=1;else{if(n&&r){t.listItems.eq(t.currentFocus+1).blur(),t.moveUp();return}n&&!r?t.currentFocus+=1:(t.listItems.eq(this.currentFocus+1).blur().end().eq(t.currentFocus).focus(),t._scrollToView("up"),t.selectBox.trigger("moveUp"))}return t._callbackSupport(e),t}});
