...
(function(e){"use strict";e(window.jQuery,window,document)})(function(e,t,n,r){"use strict";e.selectBox.selectBoxIt.prototype.moveDown=function(e){var t=this;t.currentFocus+=1;var n=t.listItems.eq(t.currentFocus).attr("data-disabled")==="true"?!0:!1,r=t.listItems.eq(t.currentFocus).nextAll("li").not("[data-disabled='true']").first().length;if(t.currentFocus===t.listItems.length)t.currentFocus-=1;else{if(n&&r){t.listItems.eq(t.currentFocus-1).blur(),t.moveDown();return}if(n&&!r)t.currentFocus-=1;else{t.listItems.eq(t.currentFocus-1).blur().end().eq(t.currentFocus).focus(),t._scrollToView("down");var i=t.options.showFirstOption?t.currentFocus:t.currentFocus-1>=0?t.currentFocus:0;t.selectBox.trigger("moveDown",{elem:t.selectBox.eq(i),"dropdown-elem":t.listItems.eq(t.currentFocus)})}}return t._callbackSupport(e),t},e.selectBox.selectBoxIt.prototype.moveUp=function(e){var t=this;t.currentFocus-=1;var n=t.listItems.eq(t.currentFocus).attr("data-disabled")==="true"?!0:!1,r=t.listItems.eq(t.currentFocus).prevAll("li").not("[data-disabled='true']").first().length;if(t.currentFocus===-1)t.currentFocus+=1;else{if(n&&r){t.listItems.eq(t.currentFocus+1).blur(),t.moveUp();return}if(n&&!r)t.currentFocus+=1;else{t.listItems.eq(this.currentFocus+1).blur().end().eq(t.currentFocus).focus(),t._scrollToView("up");var i=t.options.showFirstOption?t.currentFocus:t.currentFocus-1>=0?t.currentFocus:0;t.selectBox.trigger("moveUp",{elem:t.selectBox.eq(i),"dropdown-elem":t.listItems.eq(t.currentFocus)})}}return t._callbackSupport(e),t}});
(function(e){"use strict";e(window.jQuery,window,document)})(function(e,t,n,r){"use strict";e.selectBox.selectBoxIt.prototype._setCurrentSearchOption=function(e){var t=this;if(t.listItems.eq(e).is(":visible")&&t.listItems.eq(e).data("disabled")!==!0){t.listItems.eq(t.currentFocus).blur(),t.currentIndex=e,t.currentFocus=e,t.listItems.eq(t.currentFocus).focus(),t._scrollToView("search");var n=t.options.showFirstOption?t.currentFocus:t.currentFocus-1>=0?t.currentFocus:0;t.selectBox.trigger("search",{elem:t.selectBox.eq(n),"dropdown-elem":t.listItems.eq(t.currentFocus)})}return t},e.selectBox.selectBoxIt.prototype._searchAlgorithm=function(e,t){var n=this,r=!1,i,s,o;for(i=e,o=n.textArray.length;i<o;i+=1){for(s=0;s<o;s+=1)n.textArray[s].search(t)!==-1&&(r=!0,s=o);r||(n.currentText=n.currentText.charAt(n.currentText.length-1).replace(/[|()\[{.+*?$\\]/g,"\\$0"),t=new RegExp(n.currentText,"gi"));if(n.currentText.length<3){t=new RegExp(n.currentText.charAt(0),"gi");if(n.textArray[i].charAt(0).search(t)!==-1)return n._setCurrentSearchOption(i),n.currentIndex+=1,!1}else if(n.textArray[i].search(t)!==-1)return n._setCurrentSearchOption(i),!1;if(n.textArray[i].toLowerCase()===n.currentText.toLowerCase())return n._setCurrentSearchOption(i),n.currentText="",!1}return!0},e.selectBox.selectBoxIt.prototype.search=function(e,t,n){var r=this;t?r.currentText+=e.replace(/[|()\[{.+*?$\\]/g,"\\$0"):r.currentText=e.replace(/[|()\[{.+*?$\\]/g,"\\$0");var i=new RegExp(r.currentText,"gi"),s=r._searchAlgorithm(r.currentIndex,i);return s&&r._searchAlgorithm(0,i),r._callbackSupport(n),r}});
