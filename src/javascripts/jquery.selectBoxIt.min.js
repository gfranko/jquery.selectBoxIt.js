...
$(function(){$.selectBox.selectBoxIt.prototype.disable=function(e){var t=this;if(!t.options.disabled)return t.close(),t.selectBox.trigger("disable").attr("disabled","disabled"),t.div.removeAttr("tabindex").css("cursor","default"),$.Widget.prototype.disable.call(t),t._callbackSupport(e),t},$.selectBox.selectBoxIt.prototype._isDisabled=function(e){var t=this;return t.originalElem.disabled&&t.disable(),t}});
...
$(function(){$.selectBox.selectBoxIt.prototype.enable=function(e){var t=this;return t.options.disabled&&(t.selectBox.trigger("enable").removeAttr("disabled"),t.div.attr("tabindex",0).css("cursor","pointer"),$.Widget.prototype.enable.call(t),t._callbackSupport(e)),t}});
