...
$(function(){$.selectBox.selectBoxIt.prototype.disable=function(e){var t=this;return t.options.disabled||(t.close(),t.selectBox.trigger("disable").attr("disabled","disabled"),t.div.removeAttr("tabindex").addClass("selectboxit-disabled"),$.Widget.prototype.disable.call(t)),t._callbackSupport(e),t},$.selectBox.selectBoxIt.prototype.disableOption=function(e,t){var n=this,r,i=0,s,o;return typeof e=="number"&&(n.close(),r=n.selectBox.find("option").eq(e),i=n.options.showFirstOption?e:e-1>=0?e:0,n.selectBox.trigger("disable-option"),r.attr("disabled","disabled"),n.listItems.eq(e).attr("data-disabled","true").addClass("ui-state-disabled"),n.currentFocus===e&&(s=n.listItems.eq(n.currentFocus).nextAll("li").not("[data-disabled='true']").first().length,o=n.listItems.eq(n.currentFocus).prevAll("li").not("[data-disabled='true']").first().length,s?n.moveDown():o?n.moveUp():n.disable())),n._callbackSupport(t),n},$.selectBox.selectBoxIt.prototype._isDisabled=function(e){var t=this;return t.originalElem.disabled&&t.disable(),t}});
